...
function QuestionCard({ question, answer, onAnswer, onToggle, lang = "en" }: {
  ...
  return (
    <div className="border border-cs-border rounded-lg p-5 bg-white">
      <p className="font-body text-sm text-cs-text mb-3">{t(question.text, question.textEs, lang)}</p>
...
export default function App() {
  const [activeTab, setActiveTab] = useState<"about" | "prapare" | "zcodes">("about");
        ...
        <div className="max-w-3xl mx-auto px-6">
          <div className="flex gap-1">
            {[
              ...
              { id: "prapare" as const, label: "PRAPARE Screening" },
              { id: "zcodes" as const, label: "ICD-10 Z Codes" },
            ].map((tab) => (
              <button
                key={tab.id}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <p className="font-body text-sm text-cs-text/60 leading-relaxed">
                    Interactive SDOH screening with domain-level risk identification,
                    auto-suggested Z codes, and printable summary. Bilingual English/Spanish.
                  </p>
                </button>
                <button
                  onClick={() => setActiveTab("zcodes")}
                  className="border border-cs-text/10 rounded-lg p-6 text-left hover:border-cs-blue/30 transition-colors"
                >
                  <h3 className="font-heading text-lg text-cs-text mb-1">
